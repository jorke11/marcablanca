<html>
    <head>
        <title><?php echo $this->session->userdata("marca")["titulologin"] ?></title>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <script src="<?php echo base_url() ?>librerias/jquery/jquery-1.11.0.min.js"></script>
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
        <link rel="shortcut icon" href="<?php echo base_url() . $this->session->userdata("marca")["url"]; ?>" />
        ...
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/media/js/jquery.dataTables.min.js"></script>
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/extensions/ColReorder/js/dataTables.colReorder.min.js"></script>
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/extensions/Buttons/js/dataTables.buttons.min.js"></script>
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/jszip.min.js"></script>
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/pdfmake.min.js"></script>
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/vfs_fonts.js"></script>
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/buttons.html5.min.js"></script>
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/extensions/Buttons/js/buttons.html5.js"></script>
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/extensions/Buttons/js/buttons.colVis.js"></script>
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/extensions/Buttons/js/buttons.flash.js"></script>
        <script src="<?php echo base_url() ?>librerias/DataTables-1.10.13/extensions/Buttons/js/buttons.print.js"></script>


        <link rel="stylesheet" href="<?php echo base_url() ?>librerias/DataTables-1.10.13/media/css/jquery.dataTables.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>librerias/DataTables-1.10.13/extensions/Buttons/css/buttons.bootstrap.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>librerias/DataTables-1.10.13/extensions/Buttons/css/buttons.dataTables.min.css">
        ...
        <div class="container-fluid">
            <div class="row filas">
                <div class="col-lg-12 col-md-12 col-sm-12" >
                    <img src="<?php echo base_url() . $this->session->userdata("marca")["url"] ?>" width="30px">
                </div>
            </div>
        </div>
