                    ...
                    <div class="col-lg-2">
                        <ul class="list-group">
                            ...
                            foreach ($filter1 as $value) {
                                ?>
                                <li class="list-group-item"><input type="checkbox" class="filter-1" onclick='obj.countData()' value="<?php echo $value["filtro1"] ?>" name="filter1[]"><?php echo $value["filtro1"] ?></li>
                                <?php
                            }
                            ?>
                        </ul>
                    ...
                    <div class="col-lg-2">
                        <ul class="list-group">
                            ...
                            foreach ($filter2 as $value) {
                                ?>
                                <li class="list-group-item"><input type="checkbox" class="filter-2" onclick='obj.countData()' value="<?php echo $value["filtro2"] ?>" name="filter2[]"><?php echo $value["filtro2"] ?></li>
                                <?php
                            }
                            ?>
                        </ul>
                    ...
                    <div class="col-lg-2">
                        <ul class="list-group">
                            ...
                            foreach ($filter3 as $value) {
                                ?>
                                <li class="list-group-item"><input type="checkbox" class="filter-3" onclick='obj.countData()' value="<?php echo $value["filtro3"] ?>" name="filter3[]"><?php echo $value["filtro3"] ?></li>
                                <?php
                            }
                            ?>
                        </ul>
                    ...
                    <div class="col-lg-2">
                        <ul class="list-group">
                            ...
                            foreach ($filter4 as $value) {
                                ?>
                                <li class="list-group-item"><input type="checkbox" class="filter-4" onclick='obj.countData()' value="<?php echo $value["filtro4"] ?>" name="filter4[]"><?php echo $value["filtro4"] ?></li>
                                <?php
                            }
                            ?>
                        </ul>
                    ...
                    <div class="col-lg-2">
                        <ul class="list-group">
                            ...
                            foreach ($filter5 as $value) {
                                ?>
                                <li class="list-group-item"><input type="checkbox" class="filter-5" onclick='obj.countData()' onclick='obj.countData("<?php echo $value["filtro5"] ?>")' value="<?php echo $value["filtro5"] ?>" name="filter5[]"><?php echo $value["filtro5"] ?></li>
                                <?php
                            }
                            ?>
                        </ul>
                    ...
                    <div class="col-lg-2">
                        <ul class="list-group">
                            ...
                            foreach ($filter6 as $value) {
                                ?>
                                <li class="list-group-item"><input type="checkbox" class="filter-6" onclick='obj.countData()' value="<?php echo $value["filtro6"] ?>" name="filter6[]"><?php echo $value["filtro6"] ?></li>
                                <?php
                            }
                            ?>
                        </ul>
