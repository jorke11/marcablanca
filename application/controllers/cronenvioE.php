...
class cronenvioE extends MY_Controller {
    ...
    public function index() {
        ...
        else
        {
            ...
            if($data["cron"][0]["estado"] == 1)
            {
                ...
                $this->registraLog('cronenvioE', 'cronenvioProcess', $nuevo);
            }    
            else
            {
                $this->cronenvioIn($data["cron"][0]["id"]);
                    ...
                    while($contador < 55)
                    {
                        ...
                        {
                            echo $contador." - NO HAY MENSAJES PARA EL CANAL E<br>";
    ...
    {
        $ruta = "/var/www/html/marcablanca/logs/";
        $fecha = date("Ymd");
