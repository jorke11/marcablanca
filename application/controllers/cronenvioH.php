...
class cronenvioH extends MY_Controller {
    ...
    public function index() {
        ...
        else
        {
            ...
            if($data["cron"][0]["estado"] == 1)
            {
                ...
                $this->registraLog('cronenvioH', 'cronenvioProcess', $nuevo);
            }    
            else
            {
                        ...
                        else 
                        {
                                ...
                                for ($i = 0; $i < $tam; $i++) {
                                    ...
                                    if ($resultado) {
                                         ...
                                         * - Resumenes
                                         */
                                        $this->actualizar($data["pendientes"][$i]["id"],$data["pendientes"][$i]["idbase"],$data["pendientes"][$i]["idcarrie"],$data["pendientes"][$i]["numero"],$data["pendientes"][$i]["mensaje"],$data["pendientes"][$i]["nota"],$data["pendientes"][$i]["idcarrie"],$data["pendientes"][$i]["cargue"],'H',$data["pendientes"][$i]["fechacargue"]);
                                    }
