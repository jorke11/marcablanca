...
//    public function descargar($control, $carpeta, $nombre) {
    public function descargar($carpeta, $archivo) {
        ...
        $archivo = '/var/www/html/marcablanca/planos.c/' . $carpeta . "/" . $archivo;
        $name = $archivo;
    ...
    public function CargarTabla() {
        ...
        $archivos = $this->Directorios("/var/www/html/marcablanca/planos.c/" . $this->session->userdata("idusuario"));
        ...
        if ($archivos != FALSE) {
            foreach ($archivos as $value) {
                ...
                $value["ruta"] = str_replace("/var/www/html/marcablanca/", '', $value["ruta"]);
