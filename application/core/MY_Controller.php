...
class MY_Controller extends CI_Controller {
    ...
    public function __construct() {
        ...
        if ($this->session->userdata("client_id") != '') {
            $this->marca = $this->AdministradorModel->buscar("marca", '*', 'id=' . $this->session->userdata("client_id"), 'row');
        }
...
//                        $ruta = "/var/www/html/contactosms.new/public/menu/menu1.ini";
                        $ruta = "/var/www/html/marcablanca/public/menu/menu1.ini";
                        break;
                    }
                case 2: {
                        $ruta = "/var/www/html/marcablanca/public/menu/menu2.ini";
//                        $ruta = "/var/www/html/contactosms.new/public/menu/menu2.ini";
                        break;
                    }
                case 3: {
//                        $ruta = "/var/www/html/contactosms.new/public/menu/menu.ini";
                        $ruta = "/var/www/html/marcablanca/public/menu/menu.ini";
                        break;
                    }
            }
    ...
    function LimpiaMensaje($string) {
        ...
        $string = str_replace(
                array('á', 'à', 'ä', 'â', 'ª', '�?', 'À', 'Â', 'Ä', 'Ã'), array('a', 'a', 'a', 'a', 'a', 'A', 'A', 'A', 'A', 'A'), $string
        );
        ...
        $string = str_replace(
                array('í', 'ì', 'ï', 'ï', 'î', '�?', 'Ì', '�?', 'Î'), array('i', 'i', 'i', 'i', 'i', 'I', 'I', 'I', 'I'), $string
        );
